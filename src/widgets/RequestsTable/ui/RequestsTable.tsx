    ...
    return (
        <TableContainer
            ...
            sx={{
                ...
                maxWidth: { xs: 'calc(100% - 32px)', sm: 'calc(100% - 48px)' }, // Учитываем отступы
                width: '100%',
            ...
            <Table sx={{ tableLayout: 'fixed' }}>
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell sx={{ width: { xs: '40%', sm: '150px' } }}>E-mail</TableCell>
                        <TableCell sx={{ width: { xs: '30%', sm: '200px' } }}>Статус</TableCell>
